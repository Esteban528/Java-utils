...
class Banco {
	...
	// Palabra syncronized permite sincronizar el metodo a los hilos
	
	// Este solo se puede usar con una condición
	public synchronized void transferencia (int cuentaOrigen, int cuentaDestino, double cantidad) throws InterruptedException {
		...
		while (cuentas [cuentaOrigen]<cantidad) { // Verificar que el saldo no sea inferior a la cantidad
			...
			wait();	// El hilo se duerme meintras la condicion se cumple
		}
		...
		notifyAll(); // Notifica a los demás hilos que pueden arrancar
